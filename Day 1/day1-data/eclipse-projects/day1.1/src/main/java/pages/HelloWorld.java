...
//deployment of the servlet using annotation
@WebServlet(value="/test",loadOnStartup = 1) 
//class level mandatory anno. to tell WC following class should be used for servicing the reqs 
//ending with url-pattern of : /test
//WC : creates a map @ dep time
// adds the entry 
//key : /test
//value : pages.HelloWorld
public class HelloWorld extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		{
			pw.print("Resp from the servlet @ "+LocalDateTime.now());
